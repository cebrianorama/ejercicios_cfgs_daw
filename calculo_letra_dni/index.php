...
if(isset($_POST['calcula'])){
    ...
    if($dni=filter_input(INPUT_POST,'dni',FILTER_VALIDATE_INT)){
        $letra_dni="La letra del DNI introducido es: ".calculaletra($dni);
    }else{
        $error="Por favor, debes introducir sólo valores enteros";
    }
...
<body>
    ...
    <main>
        ...
        <form action="." method="post">
            ...
            <button id="calcula" name="calcula">Calcular letra</button>
        </form>
